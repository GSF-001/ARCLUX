...
| 01 | [docs/blueprint/01-spatial-ux.md](docs/blueprint/01-spatial-ux.md) | Spatial Universe & Navigation UX (zoom ladder, camera, semantic nav, combat camera, wreckage viz, Universal Cockpit HUD) |
