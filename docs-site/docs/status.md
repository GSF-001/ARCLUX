...
- [progres/status-core.md](https://github.com/GSF-001/ARCLUX/blob/main/progres/status-core.md) — status: pipeline, parser, indexer, graph, impact, incremental
- [progres/status-detectors.md](https://github.com/GSF-001/ARCLUX/blob/main/progres/status-detectors.md) — status: detectors
- [progres/status-web.md](https://github.com/GSF-001/ARCLUX/blob/main/progres/status-web.md) — status: web (apps/web, graph viewer, vendor-ui, theme)
- [progres/status-infra.md](https://github.com/GSF-001/ARCLUX/blob/main/progres/status-infra.md) — status: CLI, collaborator tooling, testing, cleanup, dogfood
- [progres/status-backlog.md](https://github.com/GSF-001/ARCLUX/blob/main/progres/status-backlog.md) — status: backlog
- [progres/bugs.md](https://github.com/GSF-001/ARCLUX/blob/main/progres/bugs.md) — a real bug was found in already-written code, and what the fix was
- [progres/decisions.md](https://github.com/GSF-001/ARCLUX/blob/main/progres/decisions.md) — "we chose X over Y, here's why" -- design/architecture calls, not bugs
- [progres/gotchas.md](https://github.com/GSF-001/ARCLUX/blob/main/progres/gotchas.md) — environment/tooling traps that aren't bugs in ARCLUX's own code (Termux quirks, tsconfig path resolution, Webpack config, package version pinning, terminal/paste issues)
- [progres/collaborators.md](https://github.com/GSF-001/ARCLUX/blob/main/progres/collaborators.md) — who's assigned to what, check before assuming a file is unclaimed
