// Copied from React Bits (https://reactbits.dev) — MIT License.
// https://reactbits.dev/backgrounds/threads
//
// Unmodified except for this header. Used as a Hero section background —
// see apps/web/components/marketing/Hero.tsx.
