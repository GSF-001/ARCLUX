...
#include "UE5Types.generated.h"

// Vec3: meter (mirror types.ts:18).
USTRUCT(BlueprintType)
struct FUE5_API FUE5Vec3
{
	GENERATED_BODY()
...
struct FUE5_API FUE5Entity
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite) FUE5Vec3 Position; // meter
	UPROPERTY(EditAnywhere, BlueprintReadWrite) FUE5Vec3 Velocity; // m/s
...
USTRUCT(BlueprintType)
struct FUE5_API FUE5Vessel
{
	GENERATED_BODY()
	UPROPERTY(EditAnywhere, BlueprintReadWrite) FUE5Entity Base;
...
struct FUE5_API FUE5Snapshot
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite) TArray<FUE5Vessel> Vessels;
	UPROPERTY(EditAnywhere, BlueprintReadWrite) TArray<FUE5Station> Stations;
};
...
USTRUCT(BlueprintType)
struct FUE5_API FUE5Environment
{
	GENERATED_BODY()
...
// FUE5Weapon (mirror 06 §4.8 — angka mirror, bukan rumus baru).
USTRUCT(BlueprintType)
struct FUE5_API FUE5Weapon
{
	GENERATED_BODY()
...
// FUE5Heat (mirror 05 §2.1 + §3.5). UE tampil, vonis server.
USTRUCT(BlueprintType)
struct FUE5_API FUE5Heat
{
	GENERATED_BODY()
	UPROPERTY(EditAnywhere, BlueprintReadWrite) FString PlayerId;
...
// FUE5Colony (mirror 07 §6 ← world.json + claim record).
USTRUCT(BlueprintType)
struct FUE5_API FUE5Colony
{
	GENERATED_BODY()
